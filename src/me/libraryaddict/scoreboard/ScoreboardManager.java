...
public class ScoreboardManager {
    ...
    private static Objective getObjective(Scoreboard board, DisplaySlot slot) {
        ...
        if (slot.equals(DisplaySlot.BELOW_NAME)) {
            if (board.getObjective("showhealth") == null) {
                ...
                obj.setDisplayName("§a" + IconLib.VIDA);
            }
    ...
    public static void addToTeamWithSufix(Player player, String teamName, String teamPrefix, String sufix) {
        addToTeam(player.getName(), teamName, teamPrefix, sufix, false);
