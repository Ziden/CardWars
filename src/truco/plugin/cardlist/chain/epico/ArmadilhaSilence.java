...
public class ArmadilhaSilence extends Carta {

    Skill s = new Skill(this, 15, 35) {

        @Override
        public String getName() {
            return "Armadilha Silenciante";
        }
           ...
           Block colocando = p.getTargetBlock((Set<Material>)null, 10);
            ...
            Trap t = new Trap(CardWarsPlugin.mainarena.getTeam(p.getUniqueId()), colocando,p.getUniqueId(),this) {
                ...
                public void activate(Player p) {
                    ...
                    StatusEffect.addStatusEffect(p, StatusEffect.StatusMod.SILENCE, 10);
                      p.sendMessage(ChatColor.RED+"Voce foi pego numa armadilha silenciante !");
    ...
    public String getNome() {
        return "Silencio dos Caçadores";
    }

    @Override
    public String[] getDesc() {
        return new String[]{"Coloca uma armadilha", "que deixa inimigos silenciados"};
    }
